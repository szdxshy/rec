...
# SGLS4: random negatives + co-occurrence based positives
# only positive sampling strategy is changed

class SGLS4(GraphRecommender):
    def __init__(self, conf, training_set, test_set):
        super(SGLS4, self).__init__(conf, training_set, test_set)
        args = self.config['SGLS4']
